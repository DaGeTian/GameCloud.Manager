...
namespace TexasPoker.Manager.Api.ApiControllers
{
    ...
    public class ChipBuyGiftEventsController : ApiControllerBase
    {
        ...
        public ChipBuyGiftEventsController(TexasPokerDatabaseContext database, Settings settings)
        ...
        [Route("api/events/ChipBuyGift")]
        public async Task<PluginPaginationResponse<ChipBuyGiftEventEntity>> Post([FromBody]PluginRequestInfo request)
        {
            ...
            var total = await this.Database.ChipBuyGiftEvents.CountAsync(filter, CancellationToken.None);
            ...
            var model = new PluginPaginationResponse<ChipBuyGiftEventEntity>
            {
                Page = page,
                PageSize = count,
                Raws = result,
